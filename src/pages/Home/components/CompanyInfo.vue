...
// Mock 数据
import here01 from '@/assets/img/here-01.png'
import here02 from '@/assets/img/here-02.png'
import here03 from '@/assets/img/here-03.png'
const companyList = ref<CompanyInfo[]>([
  {
    title: '让喵呜云链成为可信赖的专业伙伴',
    desc: '#被理解｜高信任｜决策确定感',
    content:
      '喵呜云链 对 用户 的价值与意义，从“搜索商品”到“被理解的推荐”，让AI成为可信赖的专业伙伴：喵呜云链顾问带来“咨询式消费”体验，每次推荐有理由、有知识、有温度。让用户不仅能“更快买”而且“更笃定地买”，每个数字顾问都有专业人格和知识逻辑，让AI从冷冰冰的工具，变成“可信任的伙伴”；',
    image: here01,
  ...
  },
  {
    ...
    content:
      '这次的喵呜云链小程序 V3.0 从顾问人格化 / 产品分析可视化 / 品牌形象系统化 三点入手基于之前发布的 V2.0 进行核心理念的 强化 和 升级。它不只是改版，而是一次品牌的信任与升级，一次体验哲学的加强与重构！未来我们会继续基于「专业顾问」的核心理念持续优化和迭代产品。',
    image: here02,
  ...
  },
  {
    ...
    content:
      '传统电商中，品牌花钱买曝光，但买不到信任。顾问式电商中，品牌通过AI顾问建立长期认知与情感绑定。喵呜云链不只是帮你卖货，而是帮你建立「被理解的品牌人格」，在这里，你的品牌不再是广告的一句口号，而是一个能被AI讲述、能被用户信任的知识体系。“我们帮你建立被理解的品牌人格，让品牌成为知识生态的一部分，而不是流量的一部分。”',
    image: here03,
    button: {
      show: true,
      text: '了解详情',
