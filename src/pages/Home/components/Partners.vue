<template>
  <section class="w-full pt-10 md:pt-16 lg:pt-20">
    <!-- 喵呜AI合作伙伴区域 -->
    <div class="bg-black pt-20 lg:pt-30 pb-15 lg:pb-30">
    ...
    <!-- 喵呜严选品牌合作伙伴 -->
    <div class="bg-[#393A52FF] pt-20 lg:pt-30 pb-15 lg:pb-30">
...
const techLogos = [
  {
    src: '/src/assets/img/partner-01.png',
    alt: 'Logo 1',
  },
  {
    src: '/src/assets/img/partner-02.png',
    alt: 'Logo 2',
  },
  {
    src: '/src/assets/img/partner-03.png',
    alt: 'Logo 3',
  },
  {
    src: '/src/assets/img/partner-04.png',
    alt: 'Logo 4',
  },
]
