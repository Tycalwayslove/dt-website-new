        ...
        >
          ...
          <div class="hidden lg:grid items-center lg:[grid-template-columns:auto_1fr] gap-20">
            ...
            <div class="w-full flex flex-col justify-center">
              ...
              <div class="mt-[30px]">
                <a
                  v-if="item.ctaText && isExternalLink(item.ctaLink)"
                  :href="item.ctaLink"
                  target="_blank"
...
const banners = ref<BannerItem[]>([
  {
    ...
    imageBase: 'banner4',
    title: '喵呜云链引领电商新范式',
    desc: '2026年1月30日，"AI+电商：业态创新与治理变革"座谈会在京召开，喵呜云链 CEO邱楠提出革命性论断："AI电商不是互联网电商的延续，而是一个全新的物种，有着截然不同的商业逻辑。"',
    ctaText: '了解详情',
  ...
  },
  {
    ...
    imageBase: 'banner1',
    title: '每一次推荐，都值得信任',
    desc: '喵呜云链，不止是工具，是懂用户需求的顾问，是懂你想法的伙伴。在这里每一次链接，都源于理解，成于信任。',
    ctaText: '了解我们',
  ...
  },
  {
    ...
    imageBase: 'banner2',
    title: '成为AI顾问，即刻出发',
    desc: '一个人，也可以是一支团队。喵呜云链让个体价值被放大，让专业被看见。新电商，新战场。',
    ctaText: '下载App',
  ...
  },
  {
    ...
    imageBase: 'banner3',
    title: '好商品就是好答案',
    desc: '入驻喵呜云链，让你的商品走进千万用户的生活。我们不只帮你卖货，让每一单都是用户笃定的选择。优质供应商火热招募中。',
    ctaText: '加入我们',
